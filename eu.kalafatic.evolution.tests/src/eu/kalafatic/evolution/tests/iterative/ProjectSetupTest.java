...
/**
 * Simulation for the initial project setup flow.
 * Lifecycle: OBSERVE -> ANALYZE -> PLAN -> VALIDATE
 */
public class ProjectSetupTest implements ISimulationTest {

    private final ITestListener listener;
    private final Random random = new Random();
    private boolean stop = false;

    public ProjectSetupTest(ITestListener listener) {
